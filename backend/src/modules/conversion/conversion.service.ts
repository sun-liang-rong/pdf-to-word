...
const ALLOWED_TYPES: Record<string, string[]> = {
  ...
  [ConversionType.OCR_PDF]: ['application/pdf'],
  [ConversionType.PROTECT_PDF]: ['application/pdf'],
  [ConversionType.UNLOCK_PDF]: ['application/pdf'],
  [ConversionType.CROP_PDF]: ['application/pdf'],
  [ConversionType.PDF_TO_EXCEL]: ['application/pdf'],
  [ConversionType.PDF_TO_PPTX]: ['application/pdf'],
  [ConversionType.PDF_TO_HTML]: ['application/pdf'],
  [ConversionType.ADD_PAGE_NUMBERS]: ['application/pdf'],
  [ConversionType.SCALE_PDF]: ['application/pdf'],
};
  ...
  getSupportedTools() {
    return [
      ...
      },
      {
        ...
        name: 'OCR识别PDF',
        description: '识别扫描版 PDF 中的文字并生成可搜索的 PDF',
        inputFormats: ['pdf'],
        outputFormat: 'pdf',
      },
      {
      ...
      },
      {
        ...
        name: 'PDF转Excel',
        description: '从 PDF 表格中提取数据并生成 Excel 文件',
        inputFormats: ['pdf'],
        outputFormat: 'xlsx',
      },
      {
        ...
        name: 'PDF转PPTX',
        description: '将 PDF 页面转换为 PowerPoint 演示文稿',
        inputFormats: ['pdf'],
        outputFormat: 'pptx',
      },
      {
        type: ConversionType.PDF_TO_HTML,
        name: 'PDF转HTML',
        description: '将 PDF 转换为包含页面资源的 HTML 压缩包',
        inputFormats: ['pdf'],
        outputFormat: 'zip',
      },
      {
        type: ConversionType.ADD_PAGE_NUMBERS,
        name: 'PDF添加页码',
        description: '为 PDF 页面添加页码',
        inputFormats: ['pdf'],
        outputFormat: 'pdf',
      },
      {
        type: ConversionType.SCALE_PDF,
        name: 'PDF页面缩放',
        description: '调整 PDF 页面尺寸和缩放比例',
        inputFormats: ['pdf'],
        outputFormat: 'pdf',
      },
    ];
